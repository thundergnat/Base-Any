use v6.c;
unit module Base::Any:ver<0.0.1>;
...
bases -4482 through -2, bases, imaginary bases -66 through -2 and 2 through 66.
...
plane. Punctuation, symbols, white-space and combining characters as digit glyphs
...
Then do the same thing with the fractional portion. The fraction is not reversed.
...
That do very nearly the same thing except they return the base, whole Array and
fraction Array as a list of three positionals rather than a hash of named values.
They work pretty much exactly the same though.
